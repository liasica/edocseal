...
func (_q *CertificationQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *CertificationQuery) FirstIDX(ctx context.Context) int {
...
func (_q *CertificationQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *CertificationQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *CertificationQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *CertificationQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CertificationQuery) Modify(modifiers ...func(s *sql.Selector)) *CertificationSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *CertificationSelect) Modify(modifiers ...func(s *sql.Selector)) *CertificationSelect {
